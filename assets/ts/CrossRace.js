...
var GeorgeZafeiropoulos = 10;
var MarinosMourouzis = 20;
var GeorgeChristodoulou = 30;
var SteliosAngeli = 40;
var AlexisMitas = 50;
var AndreasAnastasiou = 60;
var AndraKyprianou = 70;
var ChristosCharalampous = 80;
var DemetrisGeorgiou = 90;
...
function draw() {
  background(13,150,20);
	...
	/*text(10,width*0.075,height*0.07);
	text(20,width*0.15,height*0.07);
    text(30,width*0.225,height*0.07);
    text(40,width*0.3,height*0.07);
	text(50,width*0.375,height*0.07);
	text(60,width*0.45,height*0.07);
	text(70,width*0.525,height*0.07);
	text(80,width*0.6,height*0.07);
	text(90,width*0.675,height*0.07);*/
  
  fill(255);
  noStroke();
  var vertL = 0;
  while(vertL < width*0.75){
  rect(vertL,height*0.08,1,height);
    vertL = vertL + height*0.15;
  }
  ...
  fill(255);
  noStroke();
  var horizL = height*0.08;
  while(horizL < height){
  rect(0,horizL,width*0.75,1);
    horizL = horizL + height*0.04;
  }
